# main_histogram_equalization.py
from image_processing.enhancement import histogram_equalization_no_opencv
...
class HistogramEqualizationApp:
    ...
    def process_image(self):
        ...
        try:
            histogram_equalization_no_opencv(input_path, output_path)
