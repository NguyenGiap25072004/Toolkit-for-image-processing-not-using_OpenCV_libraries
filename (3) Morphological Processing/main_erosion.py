# main_erosion.py
from image_processing.morphology import erosion_no_opencv
...
class ErosionApp:
    ...
    def create_widgets(self):
        ...
        ttk.Label(param_frame, text="Iterations:", style="TLabel").grid(row=1, column=0, padx=5, pady=5, sticky="w")
        ttk.Entry(param_frame, textvariable=self.iterations, width=10, style="TEntry").grid(row=1, column=1, padx=5, pady=5)
    ...
    def process_image(self):
        ...
        try:
            erosion_no_opencv(input_path, output_path, kernel_size, iterations)
